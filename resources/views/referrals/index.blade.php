...
<div class="space-y-6 fade-in">
    ...
    <div class="glass rounded-3xl p-6">
        ...
        <div class="flex gap-3 flex-wrap">
            <a href="https://wa.me/?text={{ urlencode('Join Wetaract! Use my code: '.$user->referral_code.' at '.url('/register?ref='.$user->referral_code)) }}"
            ...
            <a href="https://twitter.com/intent/tweet?text={{ urlencode('Join Wetaract – earn money on social media! Use my code: '.$user->referral_code) }}"
                ...
                <div class="flex items-center justify-between p-4 rounded-2xl bg-slate-900/40">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500">Joined {{ \Carbon\Carbon::parse($referred->created_at)->format('M d, Y') }}</p>
                        </div>
                    </div>
...
<script>
function copyCode(code) { navigator.clipboard.writeText(code); alert('Code copied: ' + code); }
function copyLink() { navigator.clipboard.writeText(document.getElementById('referral-link').value); alert('Link copied!'); }
</script>
@endsection
