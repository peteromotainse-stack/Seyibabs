...
<head>
    ...
    <title>Reset Password – Wetaract</title>
...
<body class="bg-slate-950 text-slate-200 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        <div class="text-center mb-10">
            ...
            <h1 class="text-2xl font-black text-white">New Password</h1>
        </div>
        <div class="glass rounded-3xl p-8">
            <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
                ...
                <button type="submit" class="w-full py-4 bg-indigo-600 hover:bg-indigo-500 text-white font-black rounded-2xl text-sm transition-all shadow-lg shadow-indigo-600/20">Reset Password</button>
            </form>
        </div>
    </div>
</body>
