...
<div class="space-y-8 fade-in">
    ...
    <div class="grid md:grid-cols-2 gap-6">
        <div class="glass rounded-3xl p-8 border-2 border-indigo-500/30 relative overflow-hidden">
            ...
            <form method="POST" action="{{ route('membership.upgrade') }}">
                @csrf
                <button type="submit" class="w-full py-4 bg-indigo-600 hover:bg-indigo-500 text-white font-black rounded-2xl text-sm transition-all shadow-lg shadow-indigo-600/20">Upgrade Now – $10</button>
            </form>
        </div>
    ...
    <div class="glass rounded-3xl p-8 text-center">
        ...
        <p class="text-slate-400 mb-8">You have access to all Wetaract premium features.</p>
